...
public class JdbcTimeEntryRepository implements TimeEntryRepository {
    ...
    public TimeEntry find(Long timeEntryId) {
        ...
        TimeEntry timeEntry = (TimeEntry) jdbcTemplate.query("Select id, project_id, user_id, date, hours from time_entries where id = ?",
    ...
    public TimeEntry update(Long id, TimeEntry timeEntry) {
        ...
        jdbcTemplate.update(
                    "UPDATE time_entries SET project_id = ?, user_id = ?, date = ?, hours = ?, id = ? " ,
